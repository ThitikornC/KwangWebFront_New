...
const fetchCCTVProductData = async () => {
  try {
    const response = await axios.get(`${runtimeConfig.public.apiURL}/products/Solarcell/${route.params.brand}/${route.params.product_code}`);
            ...
            <div class="flex flex-col gap-4 items-center py-2">
              ...
              <div class="w-full flex flex-col gap-4">
                ...
                <div class="flex gap-4">
                  <button
                    class="w-20 h-10 rounded-[8px] bg-graylight shadow text-black font-thai flex justify-center items-center">2.8mm</button>
                  <button
                    class="w-20 h-10 rounded-[8px] bg-graylight shadow text-black font-thai flex justify-center items-center">4mm</button>
                </div>
              </div>
        ...
        <div class="w-full flex flex-col items-center px-10 gap-4">
          ...
          <div>
            <nuxtLink :to="products.DataSheetLink"
              class="px-4 py-2 bg-reddeep text-white flex items-center gap-2 rounded-[4px]">
              Datasheet
