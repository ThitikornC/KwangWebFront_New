...
const fetchCCTVProductData = async () => {
  try {
    const response = await axios.get(`${runtimeConfig.public.apiURL}/products/Interactive/${route.params.brand}/${route.params.product_code}`);
            ...
            <div class="flex flex-col gap-4 items-center py-2">
              ...
              <div class="w-full flex flex-col gap-4">
                ...
                <div class="flex gap-4">
                  <button
                    class="w-20 h-10 rounded-[8px] bg-graylight shadow text-black font-thai flex justify-center items-center">98 นิ้ว</button>
                </div>
              </div>
