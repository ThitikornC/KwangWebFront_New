                        ...
                        <template v-if="o.id === 'faculty'">
                          ...
                          <div class="lpk-row lpk-row--fac">
                            ...
                            >
                              ...
                              <!-- ไม่มีบรรทัดภาษาอังกฤษบนปุ่มนี้แล้ว
                                   ช่องบรรทัดที่สามถูกเวลาจริงใช้ไปแทน ซึ่งบอกอะไรได้มากกว่า
                                   คำว่า Morning/Day/Evening ที่แปลจากบรรทัดบนอยู่แล้ว
                                   (ปุ่มเลือกหัวข้อด้านบนยังมีอังกฤษอยู่ เพราะตรงนั้นไม่มีตัวเลขมาแทน) -->
