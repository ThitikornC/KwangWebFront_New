<template>
  ...
  >
    <!-- เวทีล็อกอัตราส่วน = ภาพจริง (1889:1080 — พื้นหลังโปร่งใสให้ท้องฟ้าโชว์) แสดงภาพเต็มไม่โดนครอป ปุ่มยึด % ตามภาพ -->
...
// พื้นหลังเมือง — WebP พื้นหลังโปร่งใส (ชุดเดียวกับหน้า V4) ให้ท้องฟ้าไดนามิกโชว์รอบเมือง
