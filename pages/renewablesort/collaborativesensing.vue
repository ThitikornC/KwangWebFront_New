<template>
  <div class="root-bg p-8 min-h-screen">
      ...
      <div class="running-text w-full max-w-[min(1200px,95vw)] overflow-hidden relative text-[clamp(0.875rem,1.5vw,1.25rem)] whitespace-nowrap">
        <div class="marquee">
          <div class="marquee-content">
            <span>Collaborative Sensing</span>
    ...
    <div class="flex gap-3 sm:gap-4 flex-wrap justify-center mt-8 sm:mt-10 px-4 max-w-6xl mx-auto">
      <div
        @click="openSplineDesign('Presentation')"
        class="neon-btn spline-link-card hover:from-green-100 hover:to-green-300"
      >
        <div class="card-content">
          <img src="/datacityplatform.png" alt="Presentation" class="w-12 h-12 object-contain" />
          <span class="font-thai">Presentation</span>
        </div>
      </div>
      <div
      ...
      >
        <div class="card-content">
          <img src="/datacityplatform.png" alt="Collaborative sensing" class="w-12 h-12 object-contain" />
...
const splineLinks = {
  Collaborativesensing: 'https://www.kwangunlimit.com/cs',
  Presentation: 'https://my.spline.design/gbuildingcopy-IkEUVsUF6jDjYMQXbQSS3pFb/'
}
...
<style scoped>
/* ใช้ style เดียวกับหน้า espresso.vue */
.font-thai {
